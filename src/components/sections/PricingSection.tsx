            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              <article className="group rounded-2xl bg-gradient-card border border-white/20 p-4 hover:border-rise-blue/40 hover:shadow-elegant transition-all duration-300">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 bg-background border border-border rounded-lg flex items-center justify-center text-lg flex-shrink-0">📅</div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-base group-hover:text-transparent group-hover:bg-gradient-primary group-hover:bg-clip-text transition-all duration-300 leading-tight mb-2">Atualizações Semanais</h3>
              ...
              <article className="group rounded-2xl bg-gradient-card border border-white/20 p-4 hover:border-rise-purple/40 hover:shadow-elegant transition-all duration-300">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 bg-background border border-border rounded-lg flex items-center justify-center text-lg flex-shrink-0">🤖</div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-base group-hover:text-transparent group-hover:bg-gradient-primary group-hover:bg-clip-text transition-all duration-300 leading-tight mb-2">Agentes de IA Exclusivos</h3>
              ...
              <article className="group rounded-2xl bg-gradient-card border border-white/20 p-4 hover:border-rise-orange/40 hover:shadow-elegant transition-all duration-300">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 bg-background border border-border rounded-lg flex items-center justify-center text-lg flex-shrink-0">🔍</div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-base group-hover:text-transparent group-hover:bg-gradient-primary group-hover:bg-clip-text transition-all duration-300 leading-tight mb-2">Puxador de Dados Vitalício</h3>
              ...
              <article className="group rounded-2xl bg-gradient-card border border-white/20 p-4 hover:border-rise-green/40 hover:shadow-elegant transition-all duration-300">
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-10 h-10 bg-background border border-border rounded-lg flex items-center justify-center text-lg flex-shrink-0">📦</div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-base group-hover:text-transparent group-hover:bg-gradient-primary group-hover:bg-clip-text transition-all duration-300 leading-tight mb-2">Fornecedores de Rateio</h3>
